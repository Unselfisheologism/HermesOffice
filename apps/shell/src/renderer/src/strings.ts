...
export const strings = {
  zh: {
    ...
    noContent: '（无内容）',
    // Account
    accountHermes: 'Hermes 账号',
    account: '账号',
    login: '登录',
    loginHermes: '登录 Hermes 账号',
    loggedIn: '已登录',
    loggedInHermes: '已登录 Hermes',
    ...
    onbHermesTitle: '连接 Hermes',
    onbHermesBody:
      'HermesOffice 的 AI 由本机的 Hermes 网关驱动——私密、免账号。下面检查它是否在运行。',
    onbHermesConnected: '已连接到 Hermes 网关',
    onbHermesOffline: '网关离线——启动后点击重试',
    onbHermesRetry: '重试',
    onbHermesGuide: '查看设置指南',
    onbTitle3: '人人免费',
    onbBody3: '无授权费用，无广告，无水印。',
    onbNote3: 'AI 功能可能消耗 Hermes 积分。',
    onbBack: '上一步',
  },
  en: {
    navRecent: 'Recent',
    ...
    untitled: 'Untitled',
    noContent: '(empty)',
    accountHermes: 'Hermes Account',
    account: 'Account',
    login: 'Sign in',
    loginHermes: 'Sign in with Hermes',
    loggedIn: 'Signed in',
    loggedInHermes: 'Signed in to Hermes',
    ...
    onbHermesTitle: 'Connect to Hermes',
    onbHermesBody:
      "HermesOffice's AI is powered by the Hermes gateway running on this machine — private, no account needed. Let's check it is up.",
    onbHermesConnected: 'Connected to the Hermes gateway',
    onbHermesOffline: 'Gateway offline — start it, then retry',
    onbHermesRetry: 'Retry',
    onbHermesGuide: 'Setup guide',
    onbTitle3: 'Free for everyone',
    onbBody3: 'No license fees. No ads. No watermarks.',
    onbNote3: 'AI features may consume Hermes credits.',
    onbBack: 'Back',
  },
  ja: {
    // Sidebar navigation
    ...
    noContent: '（内容なし）',
    // Account
    accountHermes: 'Hermes アカウント',
    account: 'アカウント',
    login: 'サインイン',
    loginHermes: 'Hermes アカウントでサインイン',
    loggedIn: 'サインイン済み',
    loggedInHermes: 'Hermes にサインイン済み',
    waitingLogin:
    ...
    onbHermesTitle: 'Hermes に接続',
    onbHermesBody:
      'HermesOffice の AI はこのマシン上の Hermes ゲートウェイで動作します。プライベートでアカウント不要。稼働状況を確認しましょう。',
    onbHermesConnected: 'Hermes ゲートウェイに接続済み',
    onbHermesOffline: 'ゲートウェイがオフラインです。起動して再試行してください',
    onbHermesRetry: '再試行',
    onbHermesGuide: 'セットアップガイド',
    onbTitle3: 'すべての人に無料',
    onbBody3: 'ライセンス料なし、広告なし、透かしなし。',
    onbNote3: 'AI 機能は Hermes クレジットを消費する場合があります。',
    onbBack: '戻る',
  },
  ko: {
    // Sidebar navigation
    ...
    noContent: '(내용 없음)',
    // Account
    accountHermes: 'Hermes 계정',
    account: '계정',
    login: '로그인',
    loginHermes: 'Hermes 계정으로 로그인',
    loggedIn: '로그인됨',
    loggedInHermes: 'Hermes에 로그인됨',
    ...
    onbHermesTitle: 'Hermes에 연결',
    onbHermesBody:
      'HermesOffice의 AI는 이 컴퓨터에서 실행되는 Hermes 게이트웨이로 작동합니다. 비공개이며 계정이 필요 없습니다. 실행 여부를 확인해 봅시다.',
    onbHermesConnected: 'Hermes 게이트웨이에 연결됨',
    onbHermesOffline: '게이트웨이 오프라인 — 시작한 후 다시 시도하세요',
    onbHermesRetry: '다시 시도',
    onbHermesGuide: '설정 가이드',
    onbTitle3: '모두에게 무료',
    onbBody3: '라이선스 비용 없음, 광고 없음, 워터마크 없음.',
    onbNote3: 'AI 기능은 Hermes 크레딧을 소모할 수 있습니다.',
    onbBack: '이전',
  },
  fr: {
    // Sidebar navigation
    ...
    noContent: '(vide)',
    // Account
    accountHermes: 'Compte Hermes',
    account: 'Compte',
    login: 'Se connecter',
    loginHermes: 'Se connecter avec Hermes',
    loggedIn: 'Connecté',
    loggedInHermes: 'Connecté à Hermes',
    waitingLogin:
    ...
    onbHermesTitle: 'Connexion à Hermes',
    onbHermesBody:
      "L'IA de HermesOffice est propulsée par la passerelle Hermes sur cette machine — privée, sans compte. Vérifions qu'elle fonctionne.",
    onbHermesConnected: 'Connecté à la passerelle Hermes',
    onbHermesOffline: 'Passerelle hors ligne — démarrez-la puis réessayez',
    onbHermesRetry: 'Réessayer',
    onbHermesGuide: "Guide d'installation",
    onbTitle3: 'Gratuit pour tous',
    onbBody3: 'Pas de licence. Pas de publicité. Pas de filigrane.',
    onbNote3: 'Les fonctions IA peuvent consommer des crédits Hermes.',
    onbBack: 'Retour',
  },
  de: {
    // Sidebar navigation
    ...
    noContent: '(leer)',
    // Account
    accountHermes: 'Hermes-Konto',
    account: 'Konto',
    login: 'Anmelden',
    loginHermes: 'Mit Hermes anmelden',
    loggedIn: 'Angemeldet',
    loggedInHermes: 'Bei Hermes angemeldet',
    waitingLogin:
    ...
    onbHermesTitle: 'Mit Hermes verbinden',
    onbHermesBody:
      'Die KI von HermesOffice läuft über das Hermes-Gateway auf diesem Rechner — privat, ohne Konto. Prüfen wir, ob es läuft.',
    onbHermesConnected: 'Mit dem Hermes-Gateway verbunden',
    onbHermesOffline: 'Gateway offline — starten und erneut versuchen',
    onbHermesRetry: 'Erneut versuchen',
    onbHermesGuide: 'Einrichtungsanleitung',
    onbTitle3: 'Kostenlos für alle',
    onbBody3: 'Keine Lizenzgebühren. Keine Werbung. Keine Wasserzeichen.',
    onbNote3: 'KI-Funktionen können Hermes-Credits verbrauchen.',
    onbBack: 'Zurück',
  },
  es: {
    // Sidebar navigation
    ...
    noContent: '(vacío)',
    // Account
    accountHermes: 'Cuenta de Hermes',
    account: 'Cuenta',
    login: 'Iniciar sesión',
    loginHermes: 'Iniciar sesión con Hermes',
    loggedIn: 'Sesión iniciada',
    loggedInHermes: 'Sesión iniciada en Hermes',
    waitingLogin:
    ...
    onbHermesTitle: 'Conectar con Hermes',
    onbHermesBody:
      'La IA de HermesOffice funciona con la puerta de enlace Hermes en esta máquina: privada y sin cuenta. Comprobemos que está activa.',
    onbHermesConnected: 'Conectado a la puerta de enlace Hermes',
    onbHermesOffline: 'Puerta de enlace sin conexión: iníciela y reintente',
    onbHermesRetry: 'Reintentar',
    onbHermesGuide: 'Guía de configuración',
    onbTitle3: 'Gratis para todos',
    onbBody3: 'Sin licencias. Sin anuncios. Sin marcas de agua.',
    onbNote3: 'Las funciones de IA pueden consumir créditos de Hermes.',
    onbBack: 'Atrás',
  },
  th: {
    // Sidebar navigation
    ...
    // Account
    accountHermes: 'บัญชี Hermes',
    account: 'บัญชี',
    login: 'ลงชื่อเข้าใช้',
    loginHermes: 'ลงชื่อเข้าใช้ด้วย Hermes',
    loggedIn: 'ลงชื่อเข้าใช้แล้ว',
    loggedInHermes: 'ลงชื่อเข้าใช้ Hermes แล้ว',
    ...
    onbHermesTitle: 'เชื่อมต่อกับ Hermes',
    onbHermesBody:
      'AI ของ HermesOffice ขับเคลื่อนด้วยเกตเวย์ Hermes บนเครื่องนี้ — เป็นส่วนตัว ไม่ต้องมีบัญชี มาตรวจสอบว่าทำงานอยู่',
    onbHermesConnected: 'เชื่อมต่อกับเกตเวย์ Hermes แล้ว',
    onbHermesOffline: 'เกตเวย์ออฟไลน์ — เริ่มแล้วลองอีกครั้ง',
    onbHermesRetry: 'ลองอีกครั้ง',
    onbHermesGuide: 'คู่มือการตั้งค่า',
    onbTitle3: 'ฟรีสำหรับทุกคน',
    onbBody3: 'ไม่มีค่าลิขสิทธิ์ ไม่มีโฆษณา ไม่มีลายน้ำ',
    onbNote3: 'ฟีเจอร์ AI อาจใช้เครดิต Hermes',
    onbBack: 'ย้อนกลับ',
  },
  id: {
    // Sidebar navigation
    ...
    noContent: '(kosong)',
    // Account
    accountHermes: 'Akun Hermes',
    account: 'Akun',
    login: 'Masuk',
    loginHermes: 'Masuk dengan Hermes',
    loggedIn: 'Sudah masuk',
    loggedInHermes: 'Sudah masuk ke Hermes',
    ...
    onbHermesTitle: 'Hubungkan ke Hermes',
    onbHermesBody:
      'AI HermesOffice ditenagai gateway Hermes di mesin ini — privat, tanpa akun. Mari periksa apakah sudah berjalan.',
    onbHermesConnected: 'Terhubung ke gateway Hermes',
    onbHermesOffline: 'Gateway offline — mulai lalu coba lagi',
    onbHermesRetry: 'Coba lagi',
    onbHermesGuide: 'Panduan penyiapan',
    onbTitle3: 'Gratis untuk semua',
    onbBody3: 'Tanpa biaya lisensi. Tanpa iklan. Tanpa watermark.',
    onbNote3: 'Fitur AI dapat menggunakan kredit Hermes.',
    onbBack: 'Kembali',
  },
  ru: {
    // Sidebar navigation
    ...
    noContent: '(пусто)',
    // Account
    accountHermes: 'Учётная запись Hermes',
    account: 'Учётная запись',
    login: 'Войти',
    loginHermes: 'Войти через Hermes',
    loggedIn: 'Вход выполнен',
    loggedInHermes: 'Выполнен вход в Hermes',
    ...
    onbHermesTitle: 'Подключение к Hermes',
    onbHermesBody:
      'ИИ HermesOffice работает через шлюз Hermes на этом компьютере — приватно и без аккаунта. Проверим, запущен ли он.',
    onbHermesConnected: 'Подключено к шлюзу Hermes',
    onbHermesOffline: 'Шлюз офлайн — запустите его и повторите',
    onbHermesRetry: 'Повторить',
    onbHermesGuide: 'Руководство по настройке',
    onbTitle3: 'Бесплатно для всех',
    onbBody3: 'Без лицензий. Без рекламы. Без водяных знаков.',
    onbNote3: 'Функции ИИ могут расходовать кредиты Hermes.',
    onbBack: 'Назад',
  },
  ar: {
    // Sidebar navigation
    ...
    noContent: '(فارغ)',
    // Account
    accountHermes: 'حساب Hermes',
    account: 'الحساب',
    login: 'تسجيل الدخول',
    loginHermes: 'تسجيل الدخول باستخدام Hermes',
    loggedIn: 'تم تسجيل الدخول',
    loggedInHermes: 'تم تسجيل الدخول إلى Hermes',
    ...
    onbHermesTitle: 'الاتصال بـ Hermes',
    onbHermesBody:
      'يعمل الذكاء الاصطناعي في HermesOffice عبر بوابة Hermes على هذا الجهاز — خاص وبلا حساب. لنتحقق من أنها تعمل.',
    onbHermesConnected: 'متصل ببوابة Hermes',
    onbHermesOffline: 'البوابة غير متصلة — شغّلها ثم أعد المحاولة',
    onbHermesRetry: 'إعادة المحاولة',
    onbHermesGuide: 'دليل الإعداد',
    onbTitle3: 'مجاني للجميع',
    onbBody3: 'بلا رسوم ترخيص، بلا إعلانات، بلا علامات مائية.',
    onbNote3: 'قد تستهلك ميزات الذكاء الاصطناعي أرصدة Hermes.',
    onbBack: 'رجوع',
  },
  pt: {
    navRecent: 'Recentes',
    ...
    untitled: 'Sem título',
    noContent: '(vazio)',
    accountHermes: 'Conta Hermes',
    account: 'Conta',
    login: 'Entrar',
    loginHermes: 'Entrar com a Hermes',
    loggedIn: 'Conectado',
    loggedInHermes: 'Conectado à Hermes',
    ...
    onbStart: 'Começar',
    onbStepAria: 'Página {n} de {total}',
    onbHermesTitle: 'Conectar ao Hermes',
    onbHermesBody:
      'A IA do HermesOffice funciona com o gateway Hermes nesta máquina — privado, sem conta. Vamos verificar se está no ar.',
    onbHermesConnected: 'Conectado ao gateway Hermes',
    onbHermesOffline: 'Gateway offline — inicie-o e tente novamente',
    onbHermesRetry: 'Tentar novamente',
    onbHermesGuide: 'Guia de configuração',
    onbTitle3: 'Gratuito para todos',
    onbBody3: "Sem licenças. Sem anúncios. Sem marcas d'água.",
    onbNote3: 'Os recursos de IA podem consumir créditos Hermes.',
    onbBack: 'Voltar',
  },
  it: {
    navRecent: 'Recenti',
    ...
    noContent: '(vuoto)',
    accountHermes: 'Account Hermes',
    account: 'Account',
    login: 'Accedi',
    loginHermes: 'Accedi con Hermes',
    loggedIn: 'Accesso effettuato',
    loggedInHermes: 'Accesso effettuato a Hermes',
    ...
    onbHermesTitle: 'Connetti a Hermes',
    onbHermesBody:
      "L'IA di HermesOffice è alimentata dal gateway Hermes su questa macchina — privata, senza account. Verifichiamo che sia attivo.",
    onbHermesConnected: 'Connesso al gateway Hermes',
    onbHermesOffline: 'Gateway offline — avvialo e riprova',
    onbHermesRetry: 'Riprova',
    onbHermesGuide: 'Guida alla configurazione',
    onbTitle3: 'Gratuito per tutti',
    onbBody3: 'Nessuna licenza. Nessuna pubblicità. Nessuna filigrana.',
    onbNote3: 'Le funzioni IA possono consumare crediti Hermes.',
    onbBack: 'Indietro',
  },
  pl: {
    navRecent: 'Ostatnie',
    ...
    untitled: 'Bez tytułu',
    noContent: '(pusto)',
    accountHermes: 'Konto Hermes',
    account: 'Konto',
    login: 'Zaloguj się',
    loginHermes: 'Zaloguj się przez Hermes',
    loggedIn: 'Zalogowano',
    loggedInHermes: 'Zalogowano do Hermes',
    waitingLogin:
    ...
    onbHermesTitle: 'Połącz z Hermes',
    onbHermesBody:
      'AI HermesOffice działa przez bramę Hermes na tym komputerze — prywatnie, bez konta. Sprawdźmy, czy działa.',
    onbHermesConnected: 'Połączono z bramą Hermes',
    onbHermesOffline: 'Brama offline — uruchom ją i spróbuj ponownie',
    onbHermesRetry: 'Spróbuj ponownie',
    onbHermesGuide: 'Przewodnik konfiguracji',
    onbTitle3: 'Za darmo dla każdego',
    onbBody3: 'Bez opłat licencyjnych. Bez reklam. Bez znaków wodnych.',
    onbNote3: 'Funkcje AI mogą zużywać kredyty Hermes.',
    onbBack: 'Wstecz',
  },
  nl: {
    navRecent: 'Recent',
    ...
    account: 'Account',
    login: 'Inloggen',
    loginHermes: 'Inloggen met Hermes',
    loggedIn: 'Ingelogd',
    loggedInHermes: 'Ingelogd bij Hermes',
    ...
    onbHermesTitle: 'Verbinden met Hermes',
    onbHermesBody:
      'De AI van HermesOffice draait op de Hermes-gateway op deze machine — privé, zonder account. Laten we controleren of hij draait.',
    onbHermesConnected: 'Verbonden met de Hermes-gateway',
    onbHermesOffline: 'Gateway offline — start hem en probeer opnieuw',
    onbHermesRetry: 'Opnieuw proberen',
    onbHermesGuide: 'Installatiegids',
    onbTitle3: 'Gratis voor iedereen',
    onbBody3: 'Geen licentiekosten. Geen advertenties. Geen watermerken.',
    onbNote3: 'AI-functies kunnen Hermes-credits verbruiken.',
    onbBack: 'Terug',
  },
  ms: {
    navRecent: 'Terkini',
    ...
    noContent: '(kosong)',
    accountHermes: 'Akaun Hermes',
    account: 'Akaun',
    login: 'Log masuk',
    loginHermes: 'Log masuk dengan Hermes',
    loggedIn: 'Telah log masuk',
    loggedInHermes: 'Telah log masuk ke Hermes',
    ...
    onbHermesTitle: 'Sambung ke Hermes',
    onbHermesBody:
      'AI HermesOffice dikuasakan oleh gateway Hermes pada mesin ini — peribadi, tanpa akaun. Mari semak sama ada ia berjalan.',
    onbHermesConnected: 'Disambungkan ke gateway Hermes',
    onbHermesOffline: 'Gateway luar talian — mulakan dan cuba lagi',
    onbHermesRetry: 'Cuba lagi',
    onbHermesGuide: 'Panduan persediaan',
    onbTitle3: 'Percuma untuk semua',
    onbBody3: 'Tiada yuran lesen. Tiada iklan. Tiada tera air.',
    onbNote3: 'Ciri AI mungkin menggunakan kredit Hermes.',
    onbBack: 'Kembali',
  },
  he: {
    navRecent: 'אחרונים',
    ...
    untitled: 'ללא שם',
    noContent: '(ריק)',
    accountHermes: 'חשבון Hermes',
    account: 'חשבון',
    login: 'התחברות',
    loginHermes: 'התחברות עם Hermes',
    loggedIn: 'מחובר',
    loggedInHermes: 'מחובר ל-Hermes',
    ...
    onbHermesTitle: 'התחברות ל-Hermes',
    onbHermesBody:
      'ה-AI של HermesOffice פועל דרך שער Hermes במחשב זה — פרטי, ללא חשבון. נבדוק שהוא פועל.',
    onbHermesConnected: 'מחובר לשער Hermes',
    onbHermesOffline: 'השער לא מקוון — הפעילו אותו ונסו שוב',
    onbHermesRetry: 'נסו שוב',
    onbHermesGuide: 'מדריך התקנה',
    onbTitle3: 'חינם לכולם',
    onbBody3: 'ללא דמי רישיון, ללא פרסומות, ללא סימני מים.',
    onbNote3: 'תכונות AI עשויות לצרוך קרדיטים של Hermes.',
    onbBack: 'חזרה',
  },
  hi: {
    navRecent: 'हाल के',
    ...
    noContent: '(खाली)',
    accountHermes: 'Hermes खाता',
    account: 'खाता',
    login: 'साइन इन करें',
    loginHermes: 'Hermes से साइन इन करें',
    loggedIn: 'साइन इन हो गया',
    loggedInHermes: 'Hermes में साइन इन है',
    waitingLogin:
    ...
    onbHermesTitle: 'Hermes से कनेक्ट करें',
    onbHermesBody:
      'HermesOffice का AI इसी मशीन पर चल रहे Hermes गेटवे से संचालित है — निजी, बिना खाते के। देखें कि यह चल रहा है या नहीं।',
    onbHermesConnected: 'Hermes गेटवे से कनेक्टेड',
    onbHermesOffline: 'गेटवे ऑफ़लाइन — शुरू करें और फिर से प्रयास करें',
    onbHermesRetry: 'पुनः प्रयास',
    onbHermesGuide: 'सेटअप गाइड',
    onbTitle3: 'सभी के लिए मुफ़्त',
    onbBody3: 'कोई लाइसेंस शुल्क नहीं। कोई विज्ञापन नहीं। कोई वॉटरमार्क नहीं।',
    onbNote3: 'AI सुविधाएँ Hermes क्रेडिट खर्च कर सकती हैं।',
    onbBack: 'वापस',
  },
  'zh-TW': {
    navRecent: '最近',
    ...
    untitled: '未命名',
    noContent: '（無內容）',
    accountHermes: 'Hermes 帳號',
    account: '帳號',
    login: '登入',
    loginHermes: '登入 Hermes 帳號',
    loggedIn: '已登入',
    loggedInHermes: '已登入 Hermes',
    ...
    onbHermesTitle: '連線 Hermes',
    onbHermesBody:
      'HermesOffice 的 AI 由本機的 Hermes 閘道驅動——私密、免帳號。來確認它是否在執行。',
    onbHermesConnected: '已連線到 Hermes 閘道',
    onbHermesOffline: '閘道離線——啟動後點擊重試',
    onbHermesRetry: '重試',
    onbHermesGuide: '查看設定指南',
    onbTitle3: '人人免費',
    onbBody3: '無授權費用，無廣告，無浮水印。',
    onbNote3: 'AI 功能可能消耗 Hermes 點數。',
    onbBack: '上一步',
  },
} as const
