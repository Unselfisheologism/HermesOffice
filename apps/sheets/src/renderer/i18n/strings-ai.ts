...
export const aiStrings = defineStrings({
  zh: {
    ...
    aiHermesAccount: 'Hermes 账号',
    aiAccountChecking: '检测中…',
    aiLoggedIn: '已登录',
    aiLoggedInAs: '已登录：{email}',
    aiNotLoggedIn: '未登录（AI 功能需要登录 Hermes 账号）',
    aiWaitingBrowserLogin: '等待浏览器登录…',
    aiLoginHermes: '登录 Hermes',
    aiModel: '模型',
    aiCancel: '取消',
    aiSave: '保存',
    aiUnknownError: '未知错误',
  ...
  en: {
    ...
    aiGatewayLoginBtn: 'Sign in to Hermes',
    ...
    aiHermesAccount: 'Hermes account',
    aiAccountChecking: 'Checking…',
    aiLoggedIn: 'Signed in',
    aiLoggedInAs: 'Signed in: {email}',
    aiNotLoggedIn: 'Not signed in (AI features require a Hermes account)',
    aiWaitingBrowserLogin: 'Waiting for browser sign-in…',
    aiLoginHermes: 'Sign in to Hermes',
    aiModel: 'Model',
    aiCancel: 'Cancel',
    aiSave: 'Save',
  ...
  ja: {
    ...
    aiGatewayLoginBtn: 'Hermes にサインイン',
    ...
    aiHermesAccount: 'Hermes アカウント',
    aiAccountChecking: '確認中…',
    aiLoggedIn: 'サインイン済み',
    aiLoggedInAs: 'サインイン済み: {email}',
    aiNotLoggedIn: '未サインイン（AI 機能には Hermes アカウントへのサインインが必要です）',
    aiWaitingBrowserLogin: 'ブラウザーでのサインインを待機中…',
    aiLoginHermes: 'Hermes にサインイン',
    aiModel: 'モデル',
    aiCancel: 'キャンセル',
    aiSave: '保存',
  ...
  ko: {
    ...
    aiHermesAccount: 'Hermes 계정',
    aiAccountChecking: '확인 중…',
    aiLoggedIn: '로그인됨',
    aiLoggedInAs: '로그인됨: {email}',
    aiNotLoggedIn: '로그인되지 않음(AI 기능을 사용하려면 Hermes 계정 로그인이 필요합니다)',
    aiWaitingBrowserLogin: '브라우저 로그인 대기 중…',
    aiLoginHermes: 'Hermes 로그인',
    aiModel: '모델',
    aiCancel: '취소',
    aiSave: '저장',
  ...
  fr: {
    ...
    aiGatewayLoginBtn: 'Se connecter à Hermes',
    ...
    aiHermesAccount: 'Compte Hermes',
    aiAccountChecking: 'Vérification…',
    aiLoggedIn: 'Connecté',
    aiLoggedInAs: 'Connecté : {email}',
    aiNotLoggedIn: 'Non connecté (les fonctions IA nécessitent un compte Hermes)',
    aiWaitingBrowserLogin: 'En attente de la connexion dans le navigateur…',
    aiLoginHermes: 'Se connecter à Hermes',
    aiModel: 'Modèle',
    aiCancel: 'Annuler',
    aiSave: 'Enregistrer',
  ...
  de: {
    ...
    aiGatewayLoginBtn: 'Bei Hermes anmelden',
  ...
  es: {
    ...
    aiGatewayLoginBtn: 'Iniciar sesión en Hermes',
  ...
  th: {
    ...
    aiGatewayLoginBtn: 'ลงชื่อเข้าใช้ Hermes',
  ...
  id: {
    ...
    aiGatewayLoginBtn: 'Masuk ke Hermes',
  ...
  ru: {
    ...
    aiGatewayLoginBtn: 'Войти в Hermes',
    ...
    aiHermesAccount: 'Учётная запись Hermes',
    aiAccountChecking: 'Проверка…',
    aiLoggedIn: 'Вход выполнен',
    aiLoggedInAs: 'Вход выполнен: {email}',
    aiNotLoggedIn: 'Вход не выполнен (для функций ИИ требуется учётная запись Hermes)',
    aiWaitingBrowserLogin: 'Ожидание входа в браузере…',
    aiLoginHermes: 'Войти в Hermes',
    aiModel: 'Модель',
    aiCancel: 'Отмена',
    aiSave: 'Сохранить',
  ...
  ar: {
    ...
    aiGatewayLoginBtn: 'تسجيل الدخول إلى Hermes',
  ...
  pt: {
    ...
    aiGatewayLoginBtn: 'Entrar no Hermes',
  ...
  it: {
    ...
    aiGatewayLoginBtn: 'Accedi a Hermes',
  ...
  pl: {
    ...
    aiGatewayLoginBtn: 'Zaloguj się do Hermes',
  ...
  nl: {
    ...
    aiGatewayLoginBtn: 'Aanmelden bij Hermes',
    ...
    aiNotLoggedIn: 'Niet aangemeld (AI-functies vereisen een Hermes-account)',
    aiWaitingBrowserLogin: 'Wachten op aanmelding in de browser…',
    aiLoginHermes: 'Aanmelden bij Hermes',
    aiModel: 'Model',
    aiCancel: 'Annuleren',
    aiSave: 'Opslaan',
  ...
  ms: {
    ...
    aiGatewayLoginBtn: 'Log masuk ke Hermes',
  ...
  he: {
    ...
    aiGatewayLoginBtn: 'התחבר ל-Hermes',
    ...
    aiHermesAccount: 'חשבון Hermes',
    aiAccountChecking: 'בודק…',
    aiLoggedIn: 'מחובר',
    aiLoggedInAs: 'מחובר: {email}',
    aiNotLoggedIn: 'לא מחובר (תכונות AI דורשות חשבון Hermes)',
    aiWaitingBrowserLogin: 'ממתין לכניסה בדפדפן…',
    aiLoginHermes: 'כניסה ל-Hermes',
    aiModel: 'מודל',
    aiCancel: 'ביטול',
    aiSave: 'שמירה',
  ...
  hi: {
    ...
    aiGatewayLoginBtn: 'Hermes में साइन इन करें',
  ...
  'zh-TW': {
    ...
    aiHermesAccount: 'Hermes 帳號',
    aiAccountChecking: '偵測中…',
    aiLoggedIn: '已登入',
    aiLoggedInAs: '已登入：{email}',
    aiNotLoggedIn: '未登入（AI 功能需要登入 Hermes 帳號）',
    aiWaitingBrowserLogin: '等待瀏覽器登入…',
    aiLoginHermes: '登入 Hermes',
    aiModel: '模型',
    aiCancel: '取消',
    aiSave: '儲存',
    aiUnknownError: '未知錯誤',
